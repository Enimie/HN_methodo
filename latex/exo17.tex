...
%5/ Mettre le texte dans un environnement Leftside (attention à la majuscule), et sa (pseudo)traduction (décommentée) dans un environnement Rightside; puis mettre tout cela dans un environnement pages, et ajoutez après cet environnement la commande \Pages
