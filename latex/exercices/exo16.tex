...
%1/Insérez ici l'image genealogie.jpg graĉe à \includegraphics (RQ: Source de l'image: https://books.openedition.org/efr/2282). Modifiez l'échelle de li'mage pour que ce soit satisfaisant: [xscale=0.5]
%2/tarnsformez en \adjincludegraphics[max width=\textwidth] Modifiez l'échelle de li'mage pour que ce soit satisfaisant
%3/ Transformez l'image en flottant avec l'environnement figure. Indiquez où positionner le flottant.
%4/Ajoutez-lui une légende
