...
\usepackage[style=enc,sorting=nyt, style=enc,maxbibnames=10]{biblatex}%charger le style de l'EnC (téléchargeable ici https://ctan.org/pkg/biblatex-enc)
...
\medskip
	...
	\textbf{Informations bibliographiques:} Prénom Nom, \textit{Titre du mémoire. Sous-titre du mémoire}, mémoire de master \enquote{Humanités numériques}, dir. [Noms des directeurs.trices], École nationale des chartes, 2024.
